function [phi, w, O, invO_matrix_up, invO_matrix_dn] = halfK(phi, w, O, Proj_k_half_up, Proj_k_half_dn, Phi_T, N_up, N_par)
...
% "CPMC-Lab: A Matlab Package for Constrained Path Monte Carlo Calculations" Comput. Phys. Commun. (2014)
    ...
    phi(:,1:N_up)=Proj_k_half_up*phi(:,1:N_up);
    phi(:,N_up+1:N_par)=Proj_k_half_dn*phi(:,1+N_up:N_par);
